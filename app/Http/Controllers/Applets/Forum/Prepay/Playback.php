 ...
 */
class Playback extends PayConfigure implements Comput
{
    public function establishPay($json)
    {
        ...
        $data = (new Pay) -> getPrepayId($data['uid'], $vipData -> money, $vipData -> name, $userData -> openid, $orderNum, $data['vid'], 5, $data['payChoice']);
