...
$(function() {
	...
	$.ajax({
		...
		success: function(e) {
			// 标题信息
			console.log(e)
			console.log(e.data.magazine.year)
			...
			html +=
				...
				e.data.magazine.num +
				'</span>本<span class="kuc">库存不足！</span></label></p></div> <div class = "SubscribeMore" ><a class = "purchase immediately" > 立即订阅 </a> <a class = "purchase join" id="join"> 加入购物车 </a> <div class = "More"><span class = "Subscribe" > 更多订阅： </span> <b> 起订： 总第 <span class = "Start" >' +
				...
				'</span> </p><p class = "SubscribeP"><span class = "Subscribe"> 活动积分： </span> <span> <span class = "integral"> 3 </span>积分</span> </p> <p class = "Tips" >全国快递投递， 快递不到地区采用邮局挂号配送。 包邮地区不含西藏， 新疆， 甘肃， 青海， 宁夏， 内蒙古， 海南。 </p > </div >';
