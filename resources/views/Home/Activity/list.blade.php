...
<div class="x-body">
    ...
    <xblock >
        ...
        <button class="layui-btn" onclick="x_admin_show('添加活动','/home/artivity/Add')"><i class="layui-icon"></i>添加</button>
    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "title", width: 250, title: "标题", align: "left"},
                {field: "start_at", width: 160, title: "开始时间", align: "left" , sort: true, totalRow: true},
                {field: "end_at", width: 160, title: "结束时间", align: "left"},
                {field: "limit_num", width: 100, title: "限制人数", align: "center" , sort: true, totalRow: true},
                {field: "address", width: 150, title: "地址", align: "center" , totalRow: true},
                {field: "host", width: 150, title: "主办", align: "center"},
                {field: "co_sponsor", width:150, title: "协办", align: "center"},
                {field: "ticket", width: 80, title: "票种", align: "center"},
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑活动','/home/artivity/Edit?id=' + data.id );
                    break;
            }
            ;
        })
