...
<div class="x-body">
    ...
    <xblock >
        ...
        <button class="layui-btn" onclick="x_admin_show('添加管理员','/home/admin/Add')"><i class="layui-icon"></i>添加</button>
    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "username", width: 250, title: "用户名", align: "left"},
                {field: "nikename", width: 160, title: "昵称", align: "left" ,},
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑管理员','/home/admin/Edit?id=' + data.id );
                    break;
            }
            ;
        })
