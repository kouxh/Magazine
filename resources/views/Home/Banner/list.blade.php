...
<div class="x-body">
    ...
    <xblock >
        ...
        <button class="layui-btn" onclick="x_admin_show('添加banner图','/home/banner/Add')"><i class="layui-icon"></i>添加</button>
    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "column", width: 250, title: "栏目", align: "left"},
                {field: "type", width: 160, title: "级别", align: "left"},
                {field: "alert", width: 100, title: '排序', align: "center" , },
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑活动','/home/banner/Edit?id=' + data.id );
                    break;
            }
            ;
        })
