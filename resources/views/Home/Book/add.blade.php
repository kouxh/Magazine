    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea  placeholder="" class="layui-textarea"  style="width: 65%" name="book_message" ></textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item" style="width: 80%">
            ...
            <div class="layui-input-block">
                <textarea  class="layui-textarea"  id="book_content" style="width: 65%" name="book_content" lay-verify="book_content" ></textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item" style="width: 400px;">
            ...
            <div class="layui-input-inline" style="width: 260px;">
                <input type="text" id="book_publishing_time" name="book_publishing_time" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" placeholder="例：2000年1月1日">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            </div>
