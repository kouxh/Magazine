    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "book_name", width: 250, title: "书名", align: "left"},
                {field: "title", width: 160, title: "分类", align: "left" ,},
                {field: "book_author", width: 160, title: "作者", align: "left" ,},
                {field: "book_publishing_time", width: 160, title: "发布时间", align: "left" , },
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑管理员','/home/book/Edit?id=' + data.id );
                    break;
            }
            ;
        })
