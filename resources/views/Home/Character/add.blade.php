...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item all guest" >
        ...
        <div class="layui-form-item all guest" >
            ...
            <div class="layui-input-inline" style="width: 300px;">
                <input type="text" id="post" name="post" required="" lay-verify=""
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
        ...
        <div class="layui-form-item all character" >
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" class="layui-textarea" style="width: 65%" name="golden"></textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item all character" >
            ...
            <div class="layui-form-mid layui-word-aux" >
                <span class="x-red" style="margin-left: 10px">* 尺寸大小：412 * 324</span>
            </div>
            <div>
                <input type="hidden" name="banner_video" id="banner_video">
            </div>
        </div>
        ...
        <div class="layui-form-item all character">
            ...
            <div style="margin-left:110px;width: 60%">
                <textarea  class="layui-textarea" id="experience" name="experience" style="display: none;"  lay-verify="experience" ></textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item all character">
            ...
            <div style="margin-left:110px;width: 60%">
                <textarea  class="layui-textarea" id="introduce" name="introduce" style="display: none;"  lay-verify="introduce" ></textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item all character">
            ...
            <div style="margin-left:110px;width: 60%">
                <textarea  class="layui-textarea" id="achievement" name="achievement" style="display: none;"  lay-verify="achievement" ></textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item all character" >
            ...
            <div>
                <input type="hidden" name="curriculum_img" id="curriculum_img1">
            </div>
            <div class="layui-form-mid layui-word-aux">
        ...
        <div class="layui-form-item all character" >
            ...
            <div class="layui-input-inline" style="width: 300px;">
                <input type="text" id="curriculum_url" name="curriculum_url" required="" lay-verify=""
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
