...
<div class="x-body">
    <xblock >
        ...
        <button class="layui-btn" onclick="x_admin_show('添加人物','/home/character/Add')"><i class="layui-icon"></i>添加</button>
    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "name", width: 150, title: "姓名", align: "left"},
                {field: "post", width: 150, title: "职务", align: "left"},
                {field: "golden", width: 350, title: "金句", align: "left" ,},
                {field: "introduce", width: 467, title: "介绍", align: "left" ,},
                {fixed: 'right', title: '操作', width: 110, align:'center',toolbar: '#toolbarDemo'}
            ]],
            url: "/home/character/Page",
            // headers: {
            //     'Column': column
            // },
            //data: userData,
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑权限','/home/character/Edit?id=' + data.id );
                    break;
            }
            ;
        })
