    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item" style="width: 400px;">
            ...
            <div class="layui-input-inline" style="width: 260px;">
                <input type="text" id="cl_title" name="cl_title" required="" lay-verify="required" value="{{ $data -> cl_title }}"
        ...
        <div class="layui-form-item" style="width: 400px;">
            ...
            <div class="layui-input-inline" style="width: 260px;">
                <input type="text" id="cl_lecturer" name="cl_lecturer" required="" lay-verify="required" value="{{ $data -> cl_lecturer }}"
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
        ...
        <div class="layui-form-item" style="width: 600px;">
            ...
            <div class="layui-input-inline" style="width: 260px;">
                <input type="text" id="cl_post" name="cl_post" required="" lay-verify="required" value="{{ $data -> cl_post }}"
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
        ...
        <div class="layui-form-item" style="width: 400px;">
            ...
            <div class="layui-input-inline" style="width: 260px;">
                <input type="text" id="cl_complete_post" name="cl_complete_post" required="" lay-verify="required" value="{{ $data -> cl_complete_post }}"
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea  placeholder="" class="layui-textarea"  style="width: 65%" name="cl_msg" >{{ $data -> cl_msg }}</textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item" style="width: 400px;">
            ...
            <div class="layui-input-inline" style="width: 260px;">
                <input type="text" id="cl_video_path" name="cl_video_path" required="" lay-verify="required" value="{{ $data -> cl_video_path }}"
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
        ...
        <div class="layui-form-item">
            ...
            <div>
                <input type="hidden" name="cl_img" id="cl_img" value="{{ $data -> cl_img }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            </div>
        ...
        <div class="layui-form-item" style="width: 400px;">
            ...
            <div class="layui-input-inline" style="width: 260px;">
                <input type="text" id="cl_video_path" name="cl_marvellous" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="{{ $data -> cl_marvellous}}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            </div>
        ...
        <div class="layui-form-item" style="width: 400px;">
            ...
            <div class="layui-input-inline" style="width: 260px;">
                <input type="text" id="cl_video_path" name="cl_type" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" placeholder="如：走进企业" value="{{ $data -> cl_type }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            </div>
...
<script>
    ...
    layui.use(['form','layer','layedit','laydate'], function(){
        ...
        $(document).ready(function () {
            var unitType = [];
            unitType = "{{ $data -> cl_research }}" .split(",");
            for (var j = 0; j < unitType.length; j++) {
                var unitTypeCheckbox = $("input:checkbox[name='cl_research']");
