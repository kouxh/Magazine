    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "cl_title", width: 290, title: "标题", align: "left"},
                {field: "cl_lecturer", width: 150, title: "讲师", align: "left"},
                {field: "cl_msg", width: 105, title: "介绍", align: "left"},
                {field: "cl_img", width: 105, title: "课程图片", align: "left"},
                {field: "cl_video_path", width: 280, title: "视频路径", align: "left"},
                {field: "cl_crea_at", width: 160, title: "创建时间", align: "left" , sort: true, totalRow: true},
                {fixed: 'right', title: '操作', width: 110, align:'center',toolbar: '#toolbarDemo'}
            ]],
            url: "/home/classroom/Page",
            headers:{'COLUMN' : 1},
            // headers: {
            //     'Column': column
            // },
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑活动','/home/classroom/Edit?id=' + data.cl_id );
                    break;
            }
        })
    })
