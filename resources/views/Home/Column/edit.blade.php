    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style=" width: 200px;float: left; margin-left: 0px">
                @if($data -> leven == 1)
                    <input type="radio" name="leven"  value="1" title="一级" checked>
                    <input type="radio" name="leven"  value="2" title="二级" disabled="">
                @else
                    <input type="radio" name="leven" value="1" title="一级" disabled="">
                    <input type="radio" name="leven" value="2" title="二级" checked>
                @endif
            </div>
        ...
        <div class="layui-form-item leven leven1 leven3">
            ...
            <div class="layui-input-inline">
                <input type="text" id="column" name="column" required="" lay-verify=""
                       autocomplete="off" class="layui-input" value="{{ $data -> column }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
        ...
        <div class="layui-form-item leven leven1 leven3 is-navigation">
            <label for="username" class="layui-form-label">
                栏目缩写
            </label>
            <div class="layui-input-inline" >
                <input type="text" id="english" name="english" required="" lay-verify=""
                       autocomplete="off" class="layui-input" value="{{ $data -> english }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">* 必填</span>
            </div>
        ...
        <div class="layui-form-item leven leven1 is-navigation">
            <label for="username" class="layui-form-label">
                Title
            </label>
            <div class="layui-input-inline" >
        ...
        <div class="layui-form-item leven leven1 is-navigation">
            ...
            <div class="layui-input-inline" >
                <input type="text" id="describe" name="describe" required="" lay-verify=""
                       autocomplete="off" class="layui-input" value="{{ $data -> describe }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
        ...
        <div class="layui-form-item leven leven1 is-navigation">
            ...
            <div>
                <input type="hidden" name="Pc_advert" id="Pc_advert" value="{{ $data -> Pc_advert }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">* 必填</span>
            </div>
        ...
        <div class="layui-form-item leven leven1 is-navigation">
            ...
            <div class="layui-input-inline">
                <input type="text" id="Pc_advert_url" name="Pc_advert_url" required="" lay-verify=""
                       autocomplete="off" class="layui-input" value="{{ $data -> Pc_advert_url }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">* 必填</span>
            </div>
        ...
        <div class="layui-form-item leven leven1 is-navigation">
            ...
            <div>
                <input type="hidden" name="App_advert" id="App_advert" value="{{ $data -> App_advert }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">* 必填</span>
            </div>
        ...
        <div class="layui-form-item leven leven1 is-navigation">
            ...
            <div class="layui-input-inline">
                <input type="text" id="App_advert_url" name="App_advert_url" required="" lay-verify=""
                       autocomplete="off" class="layui-input" value="{{ $data -> App_advert_url }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">* 必填</span>
            </div>
        ...
        <div class="layui-form-item leven leven1">
            ...
            <div class="layui-input-block" style=" width: 200px;float: left; margin-left: 0px">
                @if($data -> is_alert == 1)
                    <input type="radio" name="is_alert" lay-filter="is-alert" value="1" title="是" checked>
                    <input type="radio" name="is_alert" lay-filter="is-alert" value="2" title="否" >
                @else
        ...
        <div class="layui-form-item leven is-alert ">
            ...
            <div>
                <input type="hidden" name="Pc_alert_advert" id="Pc_alert_advert" value="{{ $data -> Pc_alert_advert }}">
        ...
        <div class="layui-form-item leven is-alert">
            ...
            <div class="layui-input-inline">
                <input type="text" id="Pc_alert_advert_url" name="Pc_alert_advert_url" required="" lay-verify=""
                       autocomplete="off" class="layui-input" value="{{ $data -> Pc_alert_advert_url }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">* 必填</span>
            </div>
        ...
        <div class="layui-form-item leven is-alert ">
            ...
            <div>
                <input type="hidden" name="App_alert_advert" id="App_alert_advert" value="{{ $data -> App_alert_advert }}">
        ...
        <div class="layui-form-item leven is-alert">
            ...
            <div class="layui-input-inline">
                <input type="text" id="App_alert_advert_url" name="App_alert_advert_url" required="" lay-verify=""
                       autocomplete="off" class="layui-input" value="{{ $data -> App_alert_advert_url }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">* 必填</span>
            </div>
        ...
        <div class="layui-form-item leven leven1">
            ...
            <div class="layui-input-block" style=" width: 200px;float: left; margin-left: 0px">
                @if($data -> is_banner == 1)
                    <input type="radio" name="is_banner" lay-filter="is-banner" value="1" title="是" checked>
                    <input type="radio" name="is_banner" lay-filter="is-banner" value="2" title="否" >
                @else
        ...
        <div class="layui-form-item leven is-banner ">
            ...
            <div>
                <input type="hidden" name="Pc_banner" id="Pc_banner" value="{{ $data -> Pc_banner }}">
        ...
        <div class="layui-form-item leven is-banner">
            ...
            <div class="layui-input-inline">
                <input type="text" id="Pc_banner_url" name="Pc_banner_url" required="" lay-verify=""
                       autocomplete="off" class="layui-input" value="{{ $data -> Pc_banner_url }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">* 必填</span>
            </div>
        ...
        <div class="layui-form-item leven is-banner ">
            ...
            <div>
                <input type="hidden" name="App_banner" id="App_banner" value="{{ $data -> App_banner }}">
        ...
        <div class="layui-form-item leven is-banner">
            ...
            <div class="layui-input-inline">
                <input type="text" id="App_banner_url" name="App_banner_url" required="" lay-verify=""
                       autocomplete="off" class="layui-input" value="{{ $data -> App_banner_url }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">* 必填</span>
            </div>
        ...
        <div class="layui-form-item leven leven2 leven3">
            ...
            <div class="layui-input-block" style=" width: 200px;float: left; margin-left: 0px">
                ...
                @if($data -> is_navigation == 1)
                    <input type="radio" name="is_navigation" lay-filter="is-navigation" value="1" title="是" checked>
                    <input type="radio" name="is_navigation" lay-filter="is-navigation" value="2" title="否" >
                @else
                    <input type="radio" name="is_navigation" lay-filter="is-navigation" value="1" title="是">
                    <input type="radio" name="is_navigation" lay-filter="is-navigation" value="2" title="否" checked>
                @endif
        ...
        <div class="layui-form-item leven leven1 leven3">
            ...
            <div class="layui-input-block" style=" width: 200px;float: left; margin-left: 0px">
                @if($data -> rand == 1)
                    <input type="radio" name="rand" value="1" title="是" checked="">
                    <input type="radio" name="rand" value="2" title="否" >
                @else
        ...
        <div class="layui-form-item leven leven1 leven3">
            ...
            <div class="layui-input-block" style=" width: 200px;float: left; margin-left: 0px">
                @if($data -> home_list == 1)
                    <input type="radio" name="home_list" value="1" title="是" checked="">
                    <input type="radio" name="home_list" value="2" title="否" >
                @else
        ...
        <div class="layui-form-item leven leven1 leven3">
            ...
            <div class="layui-input-block" style=" width: 200px;float: left; margin-left: 0px">
                @if($data -> join_dimension == 1)
                    <input type="radio" name="join_dimension" value="1" title="是" checked="">
                    <input type="radio" name="join_dimension" value="2" title="否" >
                @else
        ...
        <div class="layui-form-item leven  leven3">
            <label class="layui-form-label">是否升级栏目</label>
            <div class="layui-input-block" style=" width: 200px;float: left; margin-left: 0px">
                <input type="radio" name="is_upgrade" value="1" lay-filter="erweima" title="是" >
                <input type="radio" name="is_upgrade" value="2" lay-filter="erweima" title="否" checked="">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*   主：如果升级栏目会将此栏目变为一级栏目</span>
            </div>
        </div>
    ...
    layui.use(['form','layer','layedit','laydate'], function(){
        ...
        form.on('radio(erweima)', function (data) {
            ...
            if(data.value == 1){
                ...
                $('.leven2').hide();
                $('#p_id').val('');
                $("input[name=leven][value='1']").attr("checked", true);
                $("input[name=leven][value='1']").removeAttr("disabled");
                $("input[name=leven][value='2']").attr("disabled", "");
                form.render(); //更新全部
            }else{
        ...
        form.on('radio(is-navigation)' , function (data) {
            if(data.value == 1){
                $('.is-navigation').show();
                $('.sort').show();
                $('.').show();
