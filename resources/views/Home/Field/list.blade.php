...
<div class="x-body">
    <xblock >
        ...
        <button class="layui-btn" onclick="x_admin_show('添加领域','/home/field/Add')"><i class="layui-icon"></i>添加</button>
    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "class", width: 260, title: "分类（1，行业 2，兴趣 3，职业）", align: "left" ,},
                // {field: "book_author", width: 160, title: "作者", align: "left" ,},
                {field: "crea_at", width: 160, title: "发布时间", align: "left" , },
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑管理员','/home/field/Edit?id=' + data.id );
                    break;
            }
            ;
        })
