...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item" >
            ...
            <div class="layui-input-inline" style="width: 300px;">
                <input type="text" id="username" name="title" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="{{ $food -> title }}">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="username" name="author" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="{{ $food -> author }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="username" name="keyboard" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="{{ $food -> keyboard }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div>
                <input type="hidden" name="img" id="img" value="{{ $food -> img }}">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" class="layui-textarea" style="width: 65%" name="message">{{ $food -> message }}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div style="margin-left:110px;width: 60%">
                <textarea  class="layui-textarea" id="content" name="content" style="display: none;"  lay-verify="content" >{{ $food -> content }}</textarea>
            </div>
        </div>
