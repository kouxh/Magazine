...
<div class="x-body">
    <xblock >
        ...
        <button class="layui-btn" onclick="x_admin_show('添加人物','/home/guest/Add')"><i class="layui-icon"></i>添加</button>
    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "username", width: 250, title: "姓名", align: "left"},
                {field: "post", width: 350, title: "职务", align: "left" ,},
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑权限','/home/guest/Edit?id=' + data.id );
                    break;
            }
            ;
        })
