...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="/home/index">管理会计研究</a></div>
    <div class="left_open">
    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            @foreach($role as $key => $val)
                <li>
                    <a href="javascript:;">
                        <i class="layui-icon {{ $val -> role_icon }}"></i>
                        <cite>{{ $val -> role_name }}</cite>
                        <i class="iconfont nav_right">&#xe697;</i>
                    </a>
                    <ul class="sub-menu">
                        <li>
                            <a _href="/{{ $val -> role_url . '/List'}}">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>{{ $val -> role_list }}</cite>
                            </a>
                        </li >
                    </ul>
                </li>
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright">元年杂志管理中心</div>
</div>
<!-- 底部结束 -->
