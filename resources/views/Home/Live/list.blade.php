...
{{--                <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button>--}}
        <button class="layui-btn" onclick="x_admin_show('添加直播','/home/live/add')"><i class="layui-icon"></i>添加</button>
    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "l_title", width: 360, title: "标题", align: "left"},
                {field: "l_lecturer", width: 150, title: "讲师", align: "left"},
                {field: "l_time", width: 260, title: "开播时间", align: "left"},
                {field: "l_host", width: 200, title: "主办单位", align: "left"},
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑直播内容','/home/live/Edit?l_id=' + data.l_id);
                    break;
            }
            ;
        })
