...
<div class="x-body">
    <div class="layui-row">
        ...
        <div class="layui-input-inline">
            <input type="tel" name="searContent" autocomplete="off"
                   placeholder="请输入年份" class="layui-input">
        </div>
    ...
    <xblock >
        ...
        <button class="layui-btn" onclick="x_admin_show('添加杂志','/home/magazine/Add')"><i class="layui-icon"></i>添加</button>
...
{{--        </a>--}}
        <a title="编辑"  lay-event="edit" href="javascript:;">
            <i class="layui-icon layui-icon-edit" style="margin-left: 5px"></i>
        </a>
        <a title="删除" lay-event="del" href="javascript:;">
            <i class="layui-icon layui-icon-delete" style="margin-left: 5px"></i>
        </a>
    </div>
</script>
<script>
    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "year", width: 80, title: "年份", align: "left" ,sort: true, totalRow: true},
                {field: "name", width: 150, title: "类别", align: "left"},
                {field: "title", width: 200, title: "标题", align: "left"},
                {field: "subtitle", width: 200, title: "副标题", align: "left"},
                {field: "num", width: 80, title: "库存", align: "center" ,sort: true, totalRow: true},
                {field: "electronics", width: 100, title: "电子版", align: "left"},
                {field: "flat", width: 100, title: "平装", align: "left"},
                {field: "fold", width: 120, title: "是否优惠(折)", align: "center"},
                {field: "status", width: 80, title: "状态", align: "left"},
                {field: "crea_time", width: 160, title: "上架时间", align: "left" , sort: true, totalRow: true},
                {fixed: '', title: '操作', width: 110, align:'center',toolbar: '#toolbarDemo'}
            ]],
            url: "/home/magazine/Page",
            // headers: {
            //     'Column': column
            // },
            //data: userData,
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑杂志','/home/magazine/Edit?id=' + data.m_id);
                    break;
            }
            ;
        })
