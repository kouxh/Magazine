    ...
    <div class="layui-row">
        ...
        <div class="layui-input-inline">
            <input type="text" name="searContent" autocomplete="off"
                   placeholder="请输入稿件编号" class="layui-input">
        </div>
    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "man_number", width: 210, title: "稿件编号", align: "left"},
                {field: "man_title", width: 173, title: "稿件标题", align: "left"},
                {field: "man_author", width: 110, title: "稿件作者", align: "left"},
                {field: "man_column", width: 100, title: "稿件栏目", align: "left" ,},
                {field: "man_tell", width: 160, title: "联系方式", align: "left" ,},
                {field: "man_status", width: 100, title: "审核状态", align: "left" , templet:'#status'},
                {field: "man_adopt", width: 100, title: "采纳状态", align: "left" ,},
                {field: "man_crea_at", width: 160, title: "创建时间", align: "left" , },
                {fixed: 'right', title: '操作', width: 110, align:'center',toolbar: '#toolbarDemo'}
            ]],
            url: "/home/manuscript/Page",
            // headers: {
            //     'Column': column
            // },
            //data: userData,
    ...
    layui.use('table', function() {
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                case 'show':
                    layer.msg('查看');
                    x_admin_show('查看稿件','/home/manuscript/Show?id=' + data.man_id);
                    break;
                case 'del':
                    //layer.msg('删除');
                    layer.confirm('真的删除么', function (index) {
                        $.ajax({
                            url:'/home/manuscript/Del',
                            type:'get',
                            dataType:'json',
                            data:{id:data.man_id},
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑稿件','/home/manuscript/Edit?id=' + data.man_id );
                    break;
            }
            ;
        })
