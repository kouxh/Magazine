...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="flat" name="man_email" value = "{{$data -> man_work}}" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" disabled>
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="flat" name="man_email" value = "{{$data -> man_post}}" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" disabled>
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
...
{{--        </div>--}}
        ...
        <div class="layui-form-item">
            ...
            <button  type="button" onclick="openpdf('{{ $data -> man_filepath }}')" class="layui-btn" >查看稿件</button>
        </div>
    </form>
</div>
...
{{--<script>--}}
{{--    function openpdf(uul) {--}}
{{--        layui.use('layer', function () {--}}
{{--            var layer = layui.layer;--}}
{{--            layer.open({--}}
{{--                title:'<a href="./1.pdf" download="1.pdf">立即下载</a>',--}}
{{--                type: 2,--}}
{{--                area: ['1000px', '750px'],--}}
{{--                fixed: true, //不固定--}}
{{--                maxmin: true,--}}
