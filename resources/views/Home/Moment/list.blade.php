...
<div class="x-body">
    ...
    <xblock >
        ...
        <button class="layui-btn" onclick="x_admin_show('添加瞬间','/home/moment/Add')"><i class="layui-icon"></i>添加</button>
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑活动','/home/moment/Edit?id=' + data.id );
                    break;
            }
        })
    })
