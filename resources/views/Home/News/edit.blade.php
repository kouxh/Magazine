...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="username" name="keyboard" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="{{ $news -> keyboard }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            </div>
        ...
        <div class="layui-form-item" id="1">
            ...
            <div class="layui-input-inline">
                <select lay-filter="demo" name="class_id" id="class_id">
                    @if($news -> class_id == 1)
                        <option value="1" selected>业界新闻</option>
                        <option value="2">活动新闻</option>
                    @else
                        <option value="1" >业界新闻</option>
                        <option value="2" selected>活动新闻</option>
                    @endif
                </select>
            </div>
            <div class="layui-form-mid layui-word-aux">
        ...
        <div class="layui-form-item moment" >
            <label class="layui-form-label">加入精彩瞬间</label>
            <div class="layui-input-block" style=" width: 200px;float: left; margin-left: 0px">
                @if($news -> join_moment == 1)
                    <input type="radio" name="join_moment"  lay-filter="erweima" value="1" title="是" checked>
                ...
                @else
                    ...
                    <input type="radio" name="join_moment"  lay-filter="erweima" value="2" title="否" checked>
                @endif
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="related_figures" name="related_figures" required="" lay-verify=""
                       autocomplete="off" class="layui-input" value="{{ $news -> related_figures  }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" class="layui-textarea" style="width: 65%" name="message">{{ $news -> message }}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div style="margin-left:110px;width: 60%">
                <textarea  class="layui-textarea" id="content" name="content" style="display: none;"  lay-verify="content" >{{ $news -> content }}</textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="username" name="crea_at" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="{{ $news -> crea_at }}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            </div>
...
<script>
    ...
    layui.use(['form','layer','layedit'], function(){
        ...
        console.log($("#1 .layui-unselect").html())
        //插入图片
        layedit.set({
            uploadImage: {
                url: '/uploadImg' //接口url
