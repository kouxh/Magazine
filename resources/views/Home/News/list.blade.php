...
<div class="x-nav">
    ...
    <span  data-type="reload" id="getclass10" style="margin-left: 30px;">业界新闻</span>
    <span  data-type="reload" id="getclass11" style="margin-left: 30px;">活动新闻</span>
...
<div class="x-body">
    ...
    <xblock >
        ...
        <button class="layui-btn" onclick="x_admin_show('添加新闻','/home/news/Add')"><i class="layui-icon"></i>添加</button>
    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "keyboard", width: 260, title: "关键词", align: "left"},
                {field: "author", width: 160, title: "作者", align: "left"},
                {field: "class", width: 100, title: "分类", align: "left"},
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑活动','/home/news/Edit?id=' + data.id );
                    break;
            }
        })
    })
