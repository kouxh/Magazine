    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "_class", width: 250, title: "订单分类", align: "left"},
                ...
                {field: "crea_at", width: 160, title: "下单时间", align: "left" , },
                ...
                case 'deliver':
                    layer.open({
                        ...
                        ,content: '<div style="padding: 50px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">\n' +
                            ...
                            '                               autocomplete="off" class="layui-input" value="'+data.logistics_code+'" placeholder="例：123456879">\n' +
                            '                    </div>\n' +
                            '                </div>\n' +
                            '                <div class="layui-form-item">\n' +
                            '                    <label for="username" class="layui-form-label">\n' +
