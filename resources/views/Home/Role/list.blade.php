...
<div class="x-body">
    <xblock >
        ...
        <button class="layui-btn" onclick="x_admin_show('添加权限','/home/role/Add')"><i class="layui-icon"></i>添加</button>
    ...
    layui.use(["jquery", "upload", "form", "table", "layer", "element", "laydate"], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: "role_name", width: 250, title: "权限名称", align: "left"},
                {field: "role_list", width: 160, title: "权限列表", align: "left" ,},
                {field: "role_url", width: 160, title: "权限路由", align: "left" , },
                {field: "role_icon", width: 160, title: "权限图标", align: "left" , },
        ...
        table.on('tool(userTables)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'edit':
                    x_admin_show('编辑权限','/home/role/Edit?id=' + data.id );
                    break;
            }
            ;
        })
